...
int main()
{
    ...
    if(0 == getpeername(nConnectedSocket, (sockaddr *)&peeraddr, &addrlen))
    {
	std::cout << "client port: " << ntohs(peeraddr.sin_port) << std::endl;
	std::cout << "client ip: " << inet_ntoa(peeraddr.sin_addr) << std::endl;
    }
